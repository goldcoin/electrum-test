...
from electrum_glc.invoices import (PR_DEFAULT_EXPIRATION_WHEN_CREATING,
                                   PR_PAID, PR_UNKNOWN, PR_EXPIRED, PR_INFLIGHT,
                                   pr_expiration_values, Invoice)
from electrum_glc import bitcoin, constants
from electrum_glc import lnutil
from electrum_glc.transaction import tx_from_any, PartialTxOutput
from electrum_glc.util import (parse_URI, InvalidBitcoinURI, TxMinedInfo, maybe_extract_lightning_payment_identifier,
                               InvoiceError, format_time, parse_max_spend, BITCOIN_BIP21_URI_SCHEME)
from electrum_glc.lnaddr import lndecode, LnInvoiceException
from electrum_glc.lnurl import decode_lnurl, request_lnurl, callback_lnurl, LNURLError, LNURL6Data
...
from electrum_glc.gui.kivy import KIVY_GUI_PATH
from electrum_glc.gui.kivy.i18n import _

if TYPE_CHECKING:
    from electrum_glc.gui.kivy.main_window import ElectrumWindow
...
class ReceiveScreen(CScreen):
    ...
    def get_URI(self):
        from electrum_glc.util import create_bip21_uri
        amount = self.app.get_amount(self.amount)
