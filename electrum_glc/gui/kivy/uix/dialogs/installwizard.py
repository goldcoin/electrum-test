...
from electrum_glc.util import is_valid_email
...
class RestoreSeedDialog(WizardDialog):
    ...
    def __init__(self, wizard, **kwargs):
        ...
        from electrum_glc.old_mnemonic import wordlist as old_wordlist
    ...
    def update_next_button(self):
        from electrum_glc.keystore import bip39_is_checksum_valid
        text = self.get_text()
        if self.is_bip39:
