...
from electrum_glc.i18n import set_language, languages
from electrum_glc.plugin import run_hook
from electrum_glc.util import (profiler)
...
class ElectrumGui(Logger):
    ...
    def __init__(self, config: 'SimpleConfig', daemon: 'Daemon', plugins: 'Plugins'):
        ...
        self.app.engine.load('electrum_glc/gui/qml/components/main.qml')
