...
from electrum_glc import old_mnemonic
from electrum_glc.util import bh2u, bfh
from electrum_glc.mnemonic import is_new_seed, is_old_seed, seed_type
from electrum_glc.version import SEED_PREFIX_SW, SEED_PREFIX
