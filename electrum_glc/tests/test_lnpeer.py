...
import electrum_glc as electrum
import electrum_glc.trampoline
from electrum_glc import bitcoin
from electrum_glc import util
from electrum_glc import constants
from electrum_glc.network import Network
from electrum_glc.ecc import ECPrivkey
from electrum_glc import simple_config, lnutil
from electrum_glc.lnaddr import lnencode, LnAddr, lndecode
from electrum_glc.bitcoin import COIN, sha256
from electrum_glc.util import bh2u, NetworkRetryManager, bfh, OldTaskGroup, EventListener
from electrum_glc.lnpeer import Peer
from electrum_glc.lnutil import LNPeerAddr, Keypair, privkey_to_pubkey
from electrum_glc.lnutil import PaymentFailure, LnFeatures, HTLCOwner
from electrum_glc.lnchannel import ChannelState, PeerState, Channel
from electrum_glc.lnrouter import LNPathFinder, PathEdge, LNPathInconsistent
from electrum_glc.channel_db import ChannelDB
from electrum_glc.lnworker import LNWallet, NoPathFound
from electrum_glc.lnmsg import encode_msg, decode_msg
from electrum_glc import lnmsg
from electrum_glc.logging import console_stderr_handler, Logger
from electrum_glc.lnworker import PaymentInfo, RECEIVED
from electrum_glc.lnonion import OnionFailureCode
from electrum_glc.lnutil import derive_payment_secret_from_payment_preimage, UpdateAddHtlc
from electrum_glc.lnutil import LOCAL, REMOTE
from electrum_glc.invoices import PR_PAID, PR_UNPAID
from electrum_glc.interface import GracefulDisconnect
    ...
    def test_reestablish_replay_messages_rev_then_sig(self):
        ...
        async def f():
            ...
            async with OldTaskGroup() as group:
                await group.spawn(p1._message_loop())
                await group.spawn(p2._message_loop())
                with self.assertLogs('electrum_glc', level='INFO') as logs:
