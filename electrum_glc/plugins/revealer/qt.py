...
from electrum_glc.plugin import hook
from electrum_glc.i18n import _
from electrum_glc.util import make_dir, InvalidPassword, UserCancelled
from electrum_glc.gui.qt.util import (read_QIcon, EnterButton, WWLabel, icon_path,
                                      WindowModalDialog, Buttons, CloseButton, OkButton)
from electrum_glc.gui.qt.qrtextedit import ScanQRTextEdit
from electrum_glc.gui.qt.main_window import StatusBarButton
...
class Plugin(RevealerPlugin):
    ...
    def password_dialog(self, msg=None, parent=None):
        from electrum_glc.gui.qt.password_dialog import PasswordDialog
