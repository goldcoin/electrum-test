...
# (str) Package name
package.name = Electrum_GLC

# (str) Package domain (needed for android/ios packaging)
package.domain = org.electrum_glc
...
version.filename = %(source.dir)s/electrum_glc/version.py
...
presplash.filename = %(source.dir)s/electrum_glc/gui/icons/electrum_presplash.png

# (str) Icon of the application
icon.filename = %(source.dir)s/electrum_glc/gui/icons/android_electrum_icon_legacy.png
icon.adaptive_foreground.filename = %(source.dir)s/electrum_glc/gui/icons/android_electrum_icon_foreground.png
icon.adaptive_background.filename = %(source.dir)s/electrum_glc/gui/icons/android_electrum_icon_background.png
...
android.add_jars = .buildozer/android/platform/*/build/libs_collections/Electrum_glc/jar/*.jar


# (list) List of Java files to add to the android project (can be java or a
# directory containing the files)
android.add_src = electrum_glc/gui/kivy/data/java-classes/

android.gradle_dependencies = me.dm7.barcodescanner:zxing:1.9.8

android.add_activities = org.electrum_glc.qr.SimpleScannerActivity
