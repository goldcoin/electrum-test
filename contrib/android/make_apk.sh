...
#   export APP_PACKAGE_DOMAIN=org.electrum_glc
...
#export APP_PACKAGE_DOMAIN=org.electrum_glc.testnet
...
if [[ "$3" == "release" ]] ; then
    ...
    export P4A_RELEASE_KEYALIAS=electrum_glc
    ...
    export P4A_DEBUG_KEYALIAS=electrum_glc
